    ...
    <div className="animate-fade-in">
      <div className="flex justify-between items-center gap-2 mb-6">
        ...
        {canEdit && (
          <Link
            href="/survey/create"
            className="px-4 py-2 text-sm font-medium text-white bg-primary-600 rounded-md hover:bg-primary-700 inline-flex items-center gap-1 whitespace-nowrap flex-shrink-0"
          >
